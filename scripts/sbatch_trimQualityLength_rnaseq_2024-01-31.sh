...
## Usage: bash trimRNA.sh <INDIR> <PAIRED_OUTDIR> <UNPAIRED_OUTDIR>
## Outputs paired and unpaired trimmed reads to data/RNA/trimmed/paired and data/RNA/trimmed/unpaired

## Initialize variables to contain file suffixes and output paths
## Example input file: $1/$sampleName$leftInSuffix = data/RNA/rawreads/SRR_13361411_1.fastq
## Example output file: $3/$sampleName$rightOutSuffix = data/trimmed/unpaired/SRR_13361411.R2.fastq
...
# # From 2022 BINF6301: Using $1 directly in the for-loop in line 27 causes a problem.  Seems to interpret * literally?
# # Tried many permutations of /, quotes, etc. and couldn't get it to work any other way than storing $1 as a new variable
# infile="$1/"
# # Same problem is happening with $2 and $3 on Discovery but not on local.
# outpaired="$2/"
# outunpaired="$3/"

# trimAll loops through all files and trims them
function trimAll {
